    ...
    return (
        ...
        <form onSubmit={handleSubmit(onSubmit)} class="md:w-96 w-80 flex flex-col items-center justify-center">
            ...
            <div class="flex mb-5 items-center w-full bg-transparent border border-gray-300/60 h-12 rounded-full overflow-hidden pl-6 gap-2">
             ...
             <div class="flex mb-5 items-center w-full bg-transparent border border-gray-300/60 h-12 rounded-full overflow-hidden pl-6 gap-2">
                <input {...register("username" ,{required:true})} type="text" placeholder="Username" class="bg-transparent text-gray-500/80 placeholder-gray-500/80 outline-none text-sm w-full h-full" required></input>                
            </div> 
            ...
            <p class="text-gray-500/90 text-sm mt-4">Already have an account? <Link to={"/login"}
             class="text-indigo-400 hover:underline">Login</Link></p>
        </form>
    </div>
