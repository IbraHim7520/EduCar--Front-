...
<div className="p-4 rounded-lg mx-4 shadow hover:shadow-lg transition-all duration-200 w-72 shrink-0">
            <div className="flex gap-2">
                <img className="size-11 rounded-full" src={card.ReviewerImage} alt="User Image" />
                <div className="flex flex-col">
                    ...
                    <span className="text-xs text-slate-500">Rating: {card.Rating}.0</span>
                </div>
            </div>
            <p className="text-sm py-4 text-gray-800">{card.Description}</p>
            <div className="flex items-center justify-between text-slate-500 text-xs">
                <div className="flex items-center gap-1">
                    <span>{card.ClassTitle}</span>
                </div>
                <p>{card.date}</p>
            </div>
        </div>
